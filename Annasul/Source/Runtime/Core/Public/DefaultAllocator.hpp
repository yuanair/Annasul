...
namespace Annasul
{
    ...
    struct FDefaultAllocator : public FAllocator
    {
    	...
    	FORCEINLINE void* Allocate(const int32 numElements, const SIZE_T numBytesPerElement, const uint32 alignmentOfElement)
    	{
    		return FMemory::Malloc(numElements*numBytesPerElement, alignmentOfElement);
    	}

		FORCEINLINE void* Realloc(void* ptr, const int32 numElements, const SIZE_T numBytesPerElement, const uint32 alignmentOfElement)
		{
